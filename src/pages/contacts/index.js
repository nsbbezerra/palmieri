        ...
        <Container>
            ...
            <Content>
                <div className="container-contato">
                    ...
                    <span className="contato-item"><IoLogoWhatsapp /> (63) 98501-4015</span>
                    <span className="contato-item"><IoLogoWhatsapp /> (63) 98484-2266</span>
                    <span className="contato-item"><IoLogoWhatsapp /> (63) 98489-2058</span>
                    <span className="contato-item"><MdEmail /> Palmieriuniformes@gmail.com</span>

                    <h2 className="title-contato">Onde Estamos?</h2>

                    <h2 className="title-contato">Horário de Atendimento</h2>

                    <span className="contato-item"><IoIosClock /> 9:00 - 18:00 de Seg a Sex</span>
                </div>
            </Content>
        </Container>
    )
